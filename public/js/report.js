...
//Stock report table
    var stock_report_cols = [
        ...
        if ($('th.stock_price').length) {
            stock_report_cols.push({ data: 'unit_purchase_price', name: 'unit_purchase_price', searchable: false });
        ...
        stock_report_cols.push({ data: 't1_price', name: 't1_price',  searchable: false});
        stock_report_cols.push({ data: 't2_price', name: 't2_price', searchable: false});
        stock_report_cols.push({ data: 't3_price', name: 't3_price', searchable: false});
        stock_report_cols.push({ data: 'name_brands', name: 'name_brands', searchable: false});
