    ...
    <div class="row">
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                ...
                <li class="active">
                        <a href="#psr_groupprod_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list" aria-hidden="true"></i> Agrupado (Producto)</a> <!-- LAESTRADA -->
                    </li>
                    <li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="psr_groupprod_tab">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" 
                            id="product_sell_group_table">
                                <thead>
                                    <tr>
