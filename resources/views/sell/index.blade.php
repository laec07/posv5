...
$(document).ready( function(){
    ...
    sell_table = $('#sell_table').DataTable({
        ...
        columns: [
            ...
            { data: 'numerofel', name: 'numerofel',"searchable": false}, //  laestrada para sierra madre No envio
            ...
            { data: 'return_due', orderable: false, "searchable": false,@if(empty($is_return_due)) visible: false @endif}, //LAESTRADA Se agrega condiciones para que se oculten campos no necesarios
            ...
            { data: 'shipping_details', name: 'shipping_details',@if(empty($is_shipping_details)) visible: false @endif},
